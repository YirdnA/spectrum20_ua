...
\psframe(7.64,13.02)(9.13,13.22)\rput(8.38,13.12){160м Аматорське радіо}
...
\psframe(1.31,13.52)(2.47,13.72)\rput(1.89,13.62){120м Тропіки}
...
\psframe(7.24,13.52)(9.13,13.72)\rput(8.19,13.62){80м Аматорське}

%from http://www.dxing.com/tuning.htm 4750 to 4995 kHz: This is the 60-meter tropics
\psframe(1.76,14.02)(2.47,14.22)\rput(2.11,14.17){60м}\rput(2.11,14.07){Тропіки}
...
\psframe(7.24,14.1)(7.83,14.3)\rput(7.54,14.2){40м Амат.}
...
\psframe(7.24,15.1)(8.07,15.3)\rput(7.66,15.2){10м Амат.}


% 6 Meters 50-54MHz
\psframe(5.64,15.6)(6.73,15.8)\rput(6.18,15.7){6м Аматорське}
...
% \psframe(6.33,17.1)(7.30,17.35)\rput(6.82,17.27){ $\frac{3}{4}$ m Ham}
\psframe(6.33,17.1)(7.30,17.35)\rput(6.82,17.27){{3/4}м Амат.}
